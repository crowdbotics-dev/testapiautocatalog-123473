...
## Project Structure
    ...
    ├── testapiautocatalog_123473  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_123473`
...
2. Clone this repo and `cd testapiautocatalog_123473`
